...
import ma.zs.stocky.dao.facade.core.societe.SocieteDao;
import ma.zs.stocky.dao.specification.core.societe.SocieteSpecification;
...
import ma.zs.stocky.service.facade.etudiant.appartenance.VilleEtudiantService ;
import ma.zs.stocky.bean.core.appartenance.Ville ;
import ma.zs.stocky.service.facade.etudiant.appartenance.PaysEtudiantService ;
...
public class SocieteEtudiantServiceImpl implements SocieteEtudiantService {
    ...
    public long countByVilleReference(String reference){
        return dao.countByVilleReference(reference);
    }
    public List<Societe> findBySecteurActiviteId(Long id){
        return dao.findBySecteurActiviteId(id);
    }
    public int deleteBySecteurActiviteId(Long id){
        return dao.deleteBySecteurActiviteId(id);
    }
    public long countBySecteurActiviteReference(String reference){
        return dao.countBySecteurActiviteReference(reference);
    }
    public List<Societe> findByPaysId(Long id){
    ...
    public Societe findByReferenceEntity(Societe t){
        return t==null? null : dao.findByIce(t.getIce());
    }
    ...
    @Autowired
    private SecteurActiviteEtudiantService secteurActiviteService ;
    @Autowired
