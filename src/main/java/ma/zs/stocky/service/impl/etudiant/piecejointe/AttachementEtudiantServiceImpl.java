package ma.zs.stocky.service.impl.etudiant.piecejointe;
...
import java.util.List;
@Service
public class AttachementEtudiantServiceImpl implements AttachementEtudiantService {
    ...
    @Autowired
    private TypeAttachementEtudiantService typeAttachementService ;
