package ma.zs.stocky.service.impl.admin.jury;
...
import java.util.List;
@Service
public class JuryAdminServiceImpl implements JuryAdminService {
    ...
    @Autowired
    private JuryEncadrantInterneAdminService juryEncadrantInterneService ;
