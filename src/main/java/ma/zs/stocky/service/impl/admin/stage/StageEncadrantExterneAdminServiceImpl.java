...
import java.util.List;
@Service
public class StageEncadrantExterneAdminServiceImpl implements StageEncadrantExterneAdminService {
    ...
    @Autowired
    private EncadrantExterneAdminService encadrantExterneService ;
