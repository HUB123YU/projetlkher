...
import java.util.List;
@Service
public class StageEncadrantInterneEtudiantServiceImpl implements StageEncadrantInterneEtudiantService {
    ...
    @Autowired
    private EncadrantInterneEtudiantService encadrantInterneService ;
    @Autowired
