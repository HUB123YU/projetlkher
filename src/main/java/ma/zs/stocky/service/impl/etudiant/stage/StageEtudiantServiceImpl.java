...
import ma.zs.stocky.service.facade.etudiant.stage.StageAttachementEtudiantService ;
...
import ma.zs.stocky.service.facade.etudiant.stage.StageEncadrantInterneEtudiantService ;
...
public class StageEtudiantServiceImpl implements StageEtudiantService {
    ...
    @Autowired
    private StageAttachementEtudiantService stageAttachementService ;
    @Autowired
    private StageEtudiantEtudiantService stageEtudiantService ;
    @Autowired
    private JuryEtudiantService juryService ;
    @Autowired
    private FiliereEtudiantService filiereService ;
    @Autowired
    private StageEncadrantExterneEtudiantService stageEncadrantExterneService ;
    @Autowired
    private StageEncadrantInterneEtudiantService stageEncadrantInterneService ;
    @Autowired
    private TypeStageEtudiantService typeStageService ;
    @Autowired
    private DomaineEtudiantService domaineService ;
