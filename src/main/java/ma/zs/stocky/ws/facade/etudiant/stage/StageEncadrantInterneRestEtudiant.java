...
@RestController
@RequestMapping("/api/etudiant/stageEncadrantInterne/")
public class StageEncadrantInterneRestEtudiant {
    ...
    @Autowired private StageEncadrantInterneEtudiantService service;
