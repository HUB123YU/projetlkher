package  ma.zs.stocky.ws.facade.etudiant.societe;
...
@RestController
@RequestMapping("/api/etudiant/societe/")
public class SocieteRestEtudiant {
    ...
    public ResponseEntity<SocieteDto> findByIce(@PathVariable String ice) {
	    Societe t = service.findByReferenceEntity(new Societe(ice));
        if (t != null) {
            converter.init(true);
            SocieteDto dto = converter.toDto(t);
            return getDtoResponseEntity(dto);
    ...
    @Operation(summary = "find by secteurActivite id")
    @GetMapping("secteurActivite/id/{id}")
    public List<SocieteDto> findBySecteurActiviteId(@PathVariable Long id){
        return findDtos(service.findBySecteurActiviteId(id));
    }
    @Operation(summary = "delete by secteurActivite id")
    @DeleteMapping("secteurActivite/id/{id}")
    public int deleteBySecteurActiviteId(@PathVariable Long id){
        return service.deleteBySecteurActiviteId(id);
    }
    @Operation(summary = "find by pays id")
    @GetMapping("pays/id/{id}")
    public List<SocieteDto> findByPaysId(@PathVariable Long id){
        return findDtos(service.findByPaysId(id));
    }
    @Operation(summary = "delete by pays id")
    @DeleteMapping("pays/id/{id}")
    public int deleteByPaysId(@PathVariable Long id){
        return service.deleteByPaysId(id);
    }
    ...
    @Autowired private SocieteEtudiantService service;
