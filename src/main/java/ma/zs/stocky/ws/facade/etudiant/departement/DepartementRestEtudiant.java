...
import ma.zs.stocky.service.facade.etudiant.departement.DepartementEtudiantService;
...
@RestController
@RequestMapping("/api/etudiant/departement/")
public class DepartementRestEtudiant {
    ...
    @Autowired private DepartementEtudiantService service;
