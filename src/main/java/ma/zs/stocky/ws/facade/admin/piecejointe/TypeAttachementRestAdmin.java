package  ma.zs.stocky.ws.facade.admin.piecejointe;
...
@RestController
@RequestMapping("/api/admin/typeAttachement/")
public class TypeAttachementRestAdmin {
    ...
    @Autowired private TypeAttachementAdminService service;
