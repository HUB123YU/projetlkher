package  ma.zs.stocky.ws.facade.etudiant.appartenance;
...
@RestController
@RequestMapping("/api/etudiant/ville/")
public class VilleRestEtudiant {
    ...
    @Autowired private VilleEtudiantService service;
